...
<div id="main-wrapper">
    ...
    <div id="profile-page" class="content-body">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="row">
                                            ...
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <div class="d-flex align-items-center">
                                                    <img class="me-3 rounded-circle me-0 me-sm-3"
                                                        src="images/profile/3.png" width="55" height="55" alt="">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form @submit.prevent="showChangePassword">
                                        <div class="row g-3">
                                            <div class="col-12 mb-3">
                                                <label class="form-label">New Password</label>
                                                <input type="password" v-model.trim="password" class="form-control" placeholder="Enter Password"required>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label class="form-label">Retry New Password</label>
                                                <input type="password" v-model.trim="rpassword" class="form-control" placeholder="**********" required>
                                            </div>
                        ...
                        <div class="col-xxl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form @submit.prevent="showUpdateProfileDetails" class="personal_validate" novalidate="novalidate">
                                        <div class="row g-4">
                                            <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                <label class="form-label">Full Name</label>
                                                <input type="text" class="form-control" placeholder="Jannatul Maowa"
                                                v-model.trim="name" required>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                <label class="form-label">Address</label>
                                                <input type="text" class="form-control"
                                                    placeholder="123, Central Square, Brooklyn" v-model.trim="address" required>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                <label class="form-label">State</label>
                                                <input type="text" class="form-control" placeholder="New York" v-model.trim="state">
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary pl-5 pr-5">Update Profile</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

...
<div id="main-wrapper">
   <?php
    ...
    <div id="int_payment_page" class="content-body">
        <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="breadcrumbs"><a href="payment.php">Payment </a><span><i
                                    class="ri-arrow-right-s-line"></i></span><a href="#">Send International Transfer</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="btn-group">
                               <a href="create-payment.php" class="btn btn-outline-primary">Local</a>
                               <a href="#" class="btn btn-primary">International Transfer</a></div>
                        </div>
                        <div class="card-body">
                            <form @submit.prevent="showInternationalPayment" class="invoice-form">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                               <label class="form-label">
                                                ...
                                                <input type="text" v-model.trim="account_name" class="form-control" placeholder="John Doe" required>
                                            </div>
                                            <div class="mb-3">
                                               <label class="form-label">
                                                  Account Number
                                                </label>
                                                <input type="number" v-model.trim="account_number" class="form-control" placeholder="0011223344" required>
                                            </div>
                                            <div class="mb-3">
                                             <label class="form-label">
                                                Amount
                                                </label>
                                                <input type="number" v-model.trim="amount" class="form-control" placeholder="Amount in dollars ($)" required>
                                          </div>
                                        </div>
                                        <div class="col-xl-3">
                                             <div class="mb-3">
                                               <label class="form-label">
                                                ...
                                                <input type="text" v-model.trim="bank_name" class="form-control" placeholder="XYZ Bank" required>
                                             </div>
                                             <div class="mb-3">
                                               <label class="form-label">
                                                  Routing Number
                                                </label>
                                                <input type="number" v-model.trim="routing_number" class="form-control" placeholder="0011223344" required>
                                            </div>
                                            <div class="mb-3">
                                               <label class="form-label">
                                                  SWIFT or BIC Code
                                                </label>
                                                <input type="text" v-model.trim="sort_code" class="form-control" placeholder="Swift or BIC code" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="mb-3 col-xl-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Full Address of Recipient Bank">
                                        </div>
...
<script src="js/views/international_payment.js"></script>
</body>

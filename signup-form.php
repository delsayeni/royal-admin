...
<div id="register-form" class="authincation section-padding">
        ...
        <div class="row justify-content-center h-100 align-items-center">
            <div class="col-xl-5 col-md-6">
                ...
                <div class="auth-form card">
                    <div class="card-body">
                        <form id="registration-form" @submit.prevent="doRegisterForm" class="signin_validate row g-3">
                            <div class="col-12">
                                <label class="form-label">First Name</label>
                                <input type="text" v-model.trim="firstname" class="form-control" placeholder="First Name" name="firstname" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Last Name</label>
                                <input type="text" v-model.trim="lastname" class="form-control" placeholder="Last Name" name="lastname" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Address</label>
                                <input type="text" v-model.trim="address" class="form-control" placeholder="Address" name="address" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">State</label>
                                <input type="text" v-model.trim="state" class="form-control" placeholder="State" name="state" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Country</label>
                                <select class="form-select" name="country" v-model="country" required>
                            ...
                            <div class="col-12 ">
                                ...
                                <input type="email" v-model.trim="email" required class="form-control" placeholder="hello@example.com"
                                    name="email">
                            </div>
                            <div class="col-12">
                                <label class="form-label">Password</label>
                                <input type="password" v-model.trim="password" required class="form-control" placeholder="Password" name="password">
                            </div>
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" checked>
                                    <label class="form-check-label" for="flexSwitchCheckDefault">
                                        I certify that I agree to the <a href="#"
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" id="registerform-button" class="btn btn-primary">Create account</button>
                            </div>
                        </form>
...
<script src="js/views/register-form.js"></script>
